 ...
 */ class $556692a2709285a6$var$NumberLine {
   ...
   * */ computeScale() {
        ...
        this._unitLength = $556692a2709285a6$var$rangeMapper(repeater, 1, this.options.stretchModulo + 1, this.options.breakpointLowerbound, this.options.breakpointUpperBound);
...
/** Configurable callback to let the user of NumberLine to define their own tick mark labels */ module.exports.NumberLine = $556692a2709285a6$var$NumberLine;
/**
 ...
 */ function $556692a2709285a6$var$rangeMapper(x, a, b, c, d) {
